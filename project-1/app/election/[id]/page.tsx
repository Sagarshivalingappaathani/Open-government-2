  ...
  const loadElectionData = async () => {
    ...
    try {
      ...
      setElection({
        ...
        candidateCount: electionData.candidateCount.toNumber()
      });
      ...
      setHasVoted(voters.some((voter: string) => ethers.utils.getAddress(voter) === ethers.utils.getAddress(address)));
      
      setIsAdmin(ethers.utils.getAddress(address) === ethers.utils.getAddress(electionData.admin));
    } catch (error) {
